...
var Globals = []struct {
	...
	},
	{
		...
		Builtins: []*BuiltinDefinition{
			...
			{Name: "flatten", Builtin: &Builtin{Fn: globalArraysFlatten}},
	...
	},
	{
		...
		Builtins: []*BuiltinDefinition{
			...
			{Name: "delayTimer", Builtin: &Builtin{Fn: globalTimeDelayTimer}},
			{Name: "scheduleTimer", Builtin: &Builtin{Fn: globalTimeScheduleTimer}},
		},
	},
	{
		Name: "process",
